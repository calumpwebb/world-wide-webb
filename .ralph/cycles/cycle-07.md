# Cycle 07: Guest Authentication Flow
...
Implement passwordless guest authentication flow using email verification and 2FA code. Build landing page, verification page, API endpoints, and integrate with Unifi MAC authorization for network access.
...
### Task 1: Frontend: Build landing page with name/email/terms
...
### Task 2: Frontend: Build verification page with 2FA input and resend
...
### Task 3: Frontend: Build success page with welcome and auto-close
...
### Task 4: API: Implement POST /api/guest/verify-email
...
### Task 5: API: Implement POST /api/guest/verify-code
...
### Task 6: API: Implement POST /api/guest/resend-code
...
### Task 7: API: Implement GET /api/guest/status
...
### Task 8: Integrate with Unifi for MAC authorization
...
- [ ] Commit message format: `feat(cycle-07): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 07` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 07` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 08](cycle-08.md)
...
- Previous Cycle: [Cycle 06](cycle-06.md)
- Next Cycle: [Cycle 08](cycle-08.md)
