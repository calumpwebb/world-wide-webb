# Cycle 13: Guest Self-Service Portal
...
Build guest dashboard for managing devices, viewing usage statistics, and requesting access extensions. Provide guests with visibility into their connection status and bandwidth consumption.
...
### Task 1: Frontend: Build guest dashboard with overview cards
...
### Task 2: Frontend: Build device management page
...
### Task 3: Frontend: Build usage statistics page with charts
...
### Task 4: Frontend: Build request extension feature
...
### Task 5: API: Implement GET /api/portal/dashboard
...
### Task 6: API: Implement GET /api/portal/devices
...
### Task 7: API: Implement device nickname and management
...
- [ ] Commit message format: `feat(cycle-13): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 13` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 13` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 14](cycle-14.md)
...
- Previous Cycle: [Cycle 12](cycle-12.md)
- Next Cycle: [Cycle 14](cycle-14.md)
