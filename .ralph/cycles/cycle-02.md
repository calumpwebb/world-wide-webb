# Cycle 02: Next.js Project Setup & Tooling
...
Initialize Next.js 14 with TypeScript, Tailwind CSS, shadcn/ui, Vitest testing framework, ESLint/Prettier, and Husky git hooks. This cycle establishes the development environment and build tooling that all features depend on.
...
### Task 2: Setup Tailwind CSS with dark mode theme
...
### Task 3: Install and configure shadcn/ui components
...
### Task 4: Setup Vitest + Testing Library + Playwright
...
### Task 6: Setup Husky git hooks with lint-staged
...
### Task 7: Configure Docker for local development
...
- [ ] Commit message format: `feat(cycle-02): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 02` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 02` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 03](cycle-03.md)
...
- Previous Cycle: [Cycle 01](cycle-01.md)
- Next Cycle: [Cycle 03](cycle-03.md)
