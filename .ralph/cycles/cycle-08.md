...
Build secure admin login with email/password and TOTP 2FA setup. Create login page, TOTP setup page with QR code, backup codes generation, and auth middleware for admin route protection.
...
### Task 1: Frontend: Build admin login page with email/password
...
### Task 2: Frontend: Build TOTP setup page with QR and manual key
...
### Task 3: Frontend: Build backup codes display and download
...
### Task 4: API: Setup Better Auth password + TOTP config
...
### Task 5: API: Create verify-totp endpoint after login
...
### Task 6: API: Implement backup codes generation and validation
...
### Task 7: Middleware: Protect admin routes and enforce TOTP
...
- [ ] Commit message format: `feat(cycle-08): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 08` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 08` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 09](cycle-09.md)
...
- Previous Cycle: [Cycle 07](cycle-07.md)
- Next Cycle: [Cycle 09](cycle-09.md)
