...
Setup SQLite database with Drizzle ORM, create complete database schema from PRD, configure migrations, and seed admin user. This establishes data persistence for all entities: users, sessions, guests, verification codes, activity logs, and rate limits.
...
### Task 1: Initialize Drizzle ORM and SQLite configuration
...
### Task 2: Define complete database schema (8 tables)
...
### Task 3: Create database migration and initialization script
...
### Task 4: Configure Better Auth Drizzle adapter
...
### Task 5: Implement database connection utilities
...
### Task 7: Setup database health checks
...
- [ ] Commit message format: `feat(cycle-03): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 03` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 03` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 04](cycle-04.md)
...
- Previous Cycle: [Cycle 02](cycle-02.md)
- Next Cycle: [Cycle 04](cycle-04.md)
