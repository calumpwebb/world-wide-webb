...
Build Unifi Controller API client with authentication, guest authorization, device monitoring, and DPI statistics retrieval. This enables real-time network control and guest access management.
...
### Task 1: Implement UnifiClient class with login and session
...
### Task 2: Add guest authorize and revoke methods
...
### Task 3: Implement active client retrieval and monitoring
...
### Task 4: Add DPI stats querying and domain tracking
...
### Task 5: Create connection event sync with event listening
...
### Task 6: Add error handling and fail-fast pattern
...
- [ ] Commit message format: `feat(cycle-06): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 06` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 06` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 07](cycle-07.md)
...
- Previous Cycle: [Cycle 05](cycle-05.md)
- Next Cycle: [Cycle 07](cycle-07.md)
