...
Create email service abstraction supporting both Mailpit (dev) and Resend (prod). Build templates for verification codes, admin notifications, and password reset. Enable switching providers without code changes.
...
### Task 1: Create email service abstraction layer
...
### Task 2: Build verification email template with 2FA code
...
### Task 3: Build admin notification template
...
### Task 4: Build password reset email template
...
### Task 5: Implement Mailpit adapter for development
...
### Task 6: Implement Resend adapter for production
...
- [ ] Commit message format: `feat(cycle-05): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 05` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 05` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 06](cycle-06.md)
...
- Previous Cycle: [Cycle 04](cycle-04.md)
- Next Cycle: [Cycle 06](cycle-06.md)
