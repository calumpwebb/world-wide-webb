# Cycle 04: Authentication Foundation
...
Establish Better Auth with unified guest and admin authentication. Guests use passwordless email-OTP, admins use password + TOTP 2FA. This creates the security layer protecting the entire system.
...
### Task 1: Setup Better Auth core configuration
...
### Task 2: Implement guest passwordless email-OTP flow
...
### Task 3: Implement admin email+password authentication
...
### Task 4: Configure TOTP 2FA for admin with backup codes
...
### Task 5: Build authentication middleware and route protection
...
### Task 7: Setup session management and security
...
- [ ] Commit message format: `feat(cycle-04): [description]`
...
- [ ] Run `.ralph/scripts/check-cycle.sh 04` to verify
...
1. Run `.ralph/scripts/check-cycle.sh 04` to validate completion
2. Update `.ralph/TASKS.md` status (move to ✅ Completed)
3. Proceed to next cycle: [Cycle 05](cycle-05.md)
...
- Previous Cycle: [Cycle 03](cycle-03.md)
- Next Cycle: [Cycle 05](cycle-05.md)
